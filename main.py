...
def parse_kompas_files(paths):
    ...
    for path in paths:
        ...
        new_path_to_PNG = path.replace('.frw', '.png')
        ...
        ksDocument2D.SaveAsToRasterFormat(new_path_to_PNG, ksRasterFormatParam)
...
if __name__ == "__main__":
    ...
    filenames = askopenfilenames(title="Выберети файлы Компас-3D", filetypes=[('Компас 3D', '*.frw'), ])
