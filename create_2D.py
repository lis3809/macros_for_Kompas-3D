...
#Коллекция открытых документов в приложении
Documents = application.Documents

#  Открываем документ
kompas_document = Documents.Open("D:/WorkDirectory/Сборки/2/Сборка.a3d", False, True)
...
#Сделать слой текущим. Возвращаемое значение: указатель на слой
...
iDocument2D.ksSetObjParam(obj, iLayerParam, -1) #LDefin2D.ALLPARAM = -1

#Структура параметров позиционной линии-выноски
...
iMathPointArray = kompas_object.GetDynamicArray(2) #LDefin2D.POINT_ARR = 2
...
#динамический массив компонент строк текста (структура TextItemParam)
iTextItemArray = kompas_object.GetDynamicArray(4) #LDefin2D.TEXT_ITEM_ARR = 4
